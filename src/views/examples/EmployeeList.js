...
import { Container, Button, Modal, ModalHeader, ModalBody, ModalFooter, Table, Input, Row, Col, FormGroup, Label, Pagination, PaginationItem, PaginationLink } from 'reactstrap';
...
const EmployeeList = () => {
  ...
  const handleCloseModal = () => {
    ...
    setOpenModal(false);
    fetchEmployeesList(); // Refresh employee list after editing
  };
